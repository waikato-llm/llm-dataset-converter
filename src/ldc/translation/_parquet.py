...
class ParquetTranslationReader(TranslationReader, PlaceholderSupporter):
    """
    ...
    def description(self) -> str:
        ...
        :rtype: str
        """
        return "Reads translations from Parquet database files. The translation data must be in JSON format: %s" % DATA_EXAMPLE
    ...
    def read(self) -> Iterable[TranslationData]:
        ...
        :return: the data
        :rtype: Iterable[TranslationData]
        """
        self.finalize()
        ...
        for index, row in self._current_table.iterrows():
            ...
            if isinstance(val_content, str):
                val_content = json.loads(val_content)
...
class ParquetTranslationWriter(BatchTranslationWriter, PlaceholderSupporter):
    """
    ...
    def description(self) -> str:
        ...
        :rtype: str
        """
        return "Writes translation data in Parquet database format. The translation data is output in JSON format: %s" % DATA_EXAMPLE
    ...
    def _create_argparser(self) -> argparse.ArgumentParser:
        ...
        parser.add_argument("--col_content", metavar="COL", type=str, default=None, help="The name of the column for the translation data", required=False)
